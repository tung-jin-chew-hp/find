...
define([
    ...
    return substitution({
        ...
        'search.noResults.searchMore': 'No results found, checking other indexes...',
        'search.noResults.searchIndex': '{0} ({1})',
        'search.noResults.searchFound': 'No results found, consider searching the following indexes instead: {0}{1}',
