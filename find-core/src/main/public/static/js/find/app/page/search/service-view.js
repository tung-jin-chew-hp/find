define([
    ...
    return Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.geolocationView = new GeolocationView(_.defaults({ parametricCollection: this.bulkParametricCollection }, resultsViewConstructorArguments));
